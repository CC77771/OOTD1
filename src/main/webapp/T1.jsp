...
System.out.println("types_of_clothes: " + types_of_clothes);
// 取得上傳的檔案名稱
...
String sql = "INSERT INTO my_wardrobe (memberId, clothing_code, text_description, types_of_clothes, pic, color_code) VALUES(?, ?, ?, ?, ?, ?)";
PreparedStatement pstmt = con.prepareStatement(sql);
pstmt.setString(1, memberId);
pstmt.setString(2, clothing_code);
pstmt.setString(3, text_description);
pstmt.setString(4, types_of_clothes);
