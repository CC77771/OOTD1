        ...
        <div class="search-dropdown" id="searchDropdown" style="display: none;">
            <div class="dropdown-section">
                ...
                <ul class="dropdown-list">
                    <li onclick="selectSearch('零碼優惠專區')">零碼優惠專區</li>
                    <li onclick="selectSearch('針織衫')">針織衫</li>
                    <li onclick="selectSearch('溫差外套')">溫差外套</li>
                    <li onclick="selectSearch('牛仔系列')">牛仔系列</li>
                    <li onclick="selectSearch('親子裝推薦')">親子裝推薦</li>
                    <li onclick="selectSearch('秋冬新品')">秋冬新品</li>
                    <li onclick="selectSearch('人氣排行')">人氣排行</li>
                    <li onclick="selectSearch('新尺碼XXL＆160＆XS')">新尺碼XXL＆160＆XS</li>
                    <li onclick="selectSearch('熱銷到貨')">熱銷到貨</li>
                    <li onclick="selectSearch('購場穿搭')">購場穿搭</li>
                </ul>
            </div>
        </div>
    </div>
...
document.addEventListener('click', function(event) {
    const searchContainer = document.querySelector('.search-bar-wrapper');
